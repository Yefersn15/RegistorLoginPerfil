...
SECRET_KEY = 'django-insecure-=oa!xjohgn7lbatc(z%5o)@p5m3h#tjyk_i*0)iqr!izy44)39'
...
#autorizaciones de servidores o cors
...
# Configuración de idioma y zona horaria para Colombia
LANGUAGE_CODE = 'es-co'
